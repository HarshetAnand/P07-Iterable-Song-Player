...
//
// Title: P07 Iterable Song Player: LinkedNode Class
...
public class LinkedNode<T> {
  ...
  private LinkedNode<T> next; // reference to the next linked node in a list of node
  ...
  public LinkedNode(LinkedNode<T> prev, T data, LinkedNode<T> next) {
    if (data == null) {
      throw new IllegalArgumentException("Error! The data is null and should not be null!");
    }
    this.data = data;
    this.next = next;
    this.prev = prev;
